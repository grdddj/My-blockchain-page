...
async function createProject(name, goalInETH, durationInHours) {
  ...
  if (!confirm(`Do you really want to create a project named ${name}, with a goal of ${goalInETH} ETH and duration of ${durationInHours} hours?`)) {
    return
  }
  ...
  try {
    ...
    .on('receipt', function(receipt) {
      ...
      alert("The project was sucessfully created!");
    ...
    alert("Transaction didn't get through and project was not created - try again!");
  }
}
...
async function fundProject(id, amountETH) {
  // Asking the user to confirm his donation.
  if (!confirm(`Do you really want to donate ${amountETH} ETH to the Project ${id}?`)) {
    return
  }
  ...
  try {
    ...
    .on('receipt', function(receipt) {
      console.log ('receipt', receipt);
      alert("The project was sucessfully funded!");
      refreshTheDataInTable();
    })
    .on('error', function(error) {
      $("#error").html('error - Is MetaMask set to the correct address ' + accounts[0]);
    ...
    console.log ('error',error);
    alert("Transaction didn't get through and the project was not funded - try again!");
  }
}

async function withdrawFunds(id) {
  // Asking the user to confirm his donation.
  if (!confirm(`Do you really want to withdraw all funds from the project number ${id}?`)) {
    return
  }
  ...
  try {
    ...
    .on('receipt', function(receipt) {
      console.log ('receipt', receipt);
      alert("The withdrawal of funds was successful!");
    })
    .on('error', function(error) {
      $("#error").html('error - Is MetaMask set to the correct address ' + accounts[0]);
    })
    ...
    console.log ('error',error);
    alert("Transaction didn't get through and the funds were not withdrawn - try again!");
  }
}

 async function getRefund(id) {
   // Asking the user to confirm his donation.
   if (!confirm(`Do you really want to withdraw all unused funds from the project number ${id}?`)) {
     return
   }
  ...
  try {
    ...
    .on('receipt', function(receipt) {
      console.log ('receipt', receipt);
      alert("The refund of funds was successful!");
    })
    .on('error', function(error) {
      $("#error").html('error - Is MetaMask set to the correct address ' + accounts[0]);
    })
    ...
    console.log ('error',error);
    alert("Transaction didn't get through and refund was not fulfilled - try again!");
  }
}
